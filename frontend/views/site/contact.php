  ...
  <div class="container">
    ...
    <div id="w0-collapse" class="collapse navbar-collapse">
      <ul id="w1" class="navbar-nav ml-auto nav">
        ...
        <li class="nav-item"><a class="nav-link" href="<?= Url::to(['site/about']) ?>">About</a></li>
        <li class="nav-item"><a class="nav-link" href="<?= Url::to(['blog/blog']) ?>">Publish</a></li>
        <li class="nav-item"><a class="nav-link" href="<?= Url::to(['video/index']) ?>">Video</a></li>
        <li class="nav-item"><a class="nav-link" href="<?= Url::to(['site/contact']) ?>">Contact</a></li>
        <li class="nav-item"><a class="nav-link" href="<?= Url::to(['blog/index']) ?>">Blogs</a></li>
        <li class="nav-item"><a class="nav-link" href="<?= Url::to(['site/signup']) ?>">Signup</a></li>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6 mb-5 mb-lg-0">
            ...
            <img src="<?= Url::to('@web/img/aboutus/sq_img_10.jpg') ?>" alt="Image" class="img-fluid img-shadow">
          </a>
          </div>
